...
from data import (TokenBucketSampler, PrefetchLoader,
                  DetectFeatLmdb, TxtTokLmdb, ImgClsEvalDataset, imgcls_eval_collate)
...
def main(opts):
    ...
    eval_dataset = ImgClsEvalDataset(len(ans2label), eval_txt_db, eval_img_db)
    ...
    eval_dataloader = DataLoader(eval_dataset,
                                 ...
                                 collate_fn=imgcls_eval_collate)
